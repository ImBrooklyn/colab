...
func newOrganization(db *gorm.DB, opts ...gen.DOOption) organization {
	...
	_organization.Avatar = field.NewString(tableName, "avatar")
	_organization.Description = field.NewString(tableName, "description")
	_organization.Owner = field.NewInt64(tableName, "owner")
	_organization.Personal = field.NewBool(tableName, "personal")
...
func (o *organization) updateTableName(table string) *organization {
	...
	o.Personal = field.NewBool(table, "personal")
...
func (o *organization) fillFieldMap() {
	...
	o.fieldMap["personal"] = o.Personal
}
