...
func newOrganizationMember(db *gorm.DB, opts ...gen.DOOption) organizationMember {
	...
	_organizationMember.OrgID = field.NewInt64(tableName, "org_id")
	_organizationMember.UserID = field.NewInt64(tableName, "user_id")
	_organizationMember.IsOwner = field.NewBool(tableName, "is_owner")
...
func (o *organizationMember) updateTableName(table string) *organizationMember {
	...
	o.IsOwner = field.NewBool(table, "is_owner")
